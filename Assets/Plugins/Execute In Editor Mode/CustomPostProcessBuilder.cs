...
/// </summary>
public static class CustomPostProcessBuilder
{
	...
	static Framework[] ListFrameworksToAdd //ненужные фреймворки закоментить
	{
		get
		{
	...
	public static void OnPostProcessBuild(BuildTarget target, string path)
	{
		...
		#if UNITY_IPHONE
		{
			...
			Framework[] frameworksToAdd = ListFrameworksToAdd;
		...
		#endif
		Debug.Log("POST PROCESS BUILD HAS FINISHED") ;
	}
